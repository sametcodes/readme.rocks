...
export const getRepositoryMilestone: ViewComponent = (result, config) => {
  ...
  return (
    ...
    >
      ...
      />
      <text fill="#636363">
        <tspan x="271.461" y="142.943">
          {milestone.closedPullRequests.totalCount}/
          {milestone.pullRequests.totalCount} PRs closed
        </tspan>
      </text>
      ...
      <text fill="#636363">
        <tspan x="43" y="115.943">
          %{percent_in_text} complete
        </tspan>
      </text>
      <g>
      ...
      <text fill="#5E5E5E">
        <tspan x="17" y="40.7539" fontWeight={500} fontSize={25}>
          {milestone.title}
        </tspan>
      </text>
      <defs>
