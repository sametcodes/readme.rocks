      ...
      <div className="pt-20 w-full">
        ...
        >
          ...
          <div className="shadow-card flex h-[46px] w-[82px] items-center justify-center rounded-md bg-white">
            <span
              className={cn(
                "bg-primary flex h-9 w-9 items-center justify-center rounded ",
                !darkMode ? "bg-[#ffdd00] text-white" : "text-gray-800"
              )}
            >
              <svg
                width="16"
            ...
            <span
              className={cn(
                "text-body-color flex h-9 w-9 items-center justify-center rounded",
