...
import { wrapText, convertDateFormat } from "@/lib/@dsvgui/utils";

export const listArticles: ViewComponent = async (result, config) => {
  const articles = result.data.data.page.edges;

  const promise_images = articles.map(async (article: any, key: number) => {
  ...
  return (
    <Article width={398} height={110 * articles.length}>
      <>
              ...
              <>
                <g transform={`translate(0 ${yOffset})`}>
                  ...
                  <g transform={`translate(119 24)`}>
                    ...
                    >
                      {wrapText(
                        article.node.description.slice(0, 140) + "...",
                  ...
                  <g transform={`translate(119 100)`}>
                    <g transform={`translate(15 0)`}>
                      ...
                      <text fill="#555" fontSize="8" x="0" y="0">
                        {convertDateFormat(article.node.createdAt)}
                      </text>
                    </g>
